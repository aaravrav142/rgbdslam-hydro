...
#endif
  flannIndex(NULL),
  base2points_(tf::Transform::getIdentity(), ros::Time(0,point_cloud->header.stamp),ParameterServer::instance()->get<std::string>("base_frame_name"), point_cloud->header.frame_id),
  ground_truth_transform_(tf::Transform::getIdentity(), ros::Time(0,point_cloud->header.stamp), ParameterServer::instance()->get<std::string>("ground_truth_frame_name"), ParameterServer::instance()->get<std::string>("base_frame_name")),
  odom_transform_(tf::Transform::getIdentity(), ros::Time(0,point_cloud->header.stamp), "missing_odometry", point_cloud->header.frame_id),
  initial_node_matches_(0)
{
